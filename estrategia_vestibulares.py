...
class Downloader():
    ...
    def index(self):
        ...
        self.account_header = {
            'authority': 'www.estrategiavestibulares.com.br',
            'cache-control': 'max-age=0',
            'upgrade-insecure-requests': '1',
            'origin': 'https://www.estrategiavestibulares.com.br',
            ...
            'referer': 'https://www.estrategiavestibulares.com.br/autenticacao/login/',
        ...
        conta = estrategia_session.get('https://www.estrategiavestibulares.com.br/aluno/perfil', headers=self.account_header, cookies=cookies)
    ...
    def selenium_part(self):
        ...
        driver.get('https://www.estrategiavestibulares.com.br/autenticacao/login/')

        email = 'princeandrews081@gmail.com' #input('Login: ') #
        senha = 'Namorada chata123' #input('Senha: ') #
    ...
    def meus_cursos(self, cookies):
        ...
        infos = estrategia_session.get('https://www.estrategiavestibulares.com.br/aluno/', headers=self.account_header, cookies=cookies)
        ...
        for curso in cursos:
            ...
            curso_parser = bs(estrategia_session.get(f'https://www.estrategiavestibulares.com.br{curso_link}', headers=self.account_header, cookies=cookies).content, 'html.parser')
            ...
            for lecture in data:
                ...
                for index, video in enumerate(videos, start=1):
                    ...
                    if os.path.exists(path) is False:
                        link = f"https://www.estrategiavestibulares.com.br{video['url']}"
                        driver.execute_script(f'''window.open("{link}","_blank");''')
                        time.sleep(3)
                        driver.switch_to.window(driver.window_handles[1])
                        new_link = driver.current_url
                        if 'estrategiavestibulares' in new_link:
                ...
                for pdf in pdfs:
                    for index, archive in enumerate(pdf, start=1):
                        ...
                        if os.path.exists(path) is False:
                            link = f"https://www.estrategiavestibulares.com.br{archive['url']}"
                            driver.execute_script(f'''window.open("{link}","_blank");''')
                            time.sleep(3)
                            driver.switch_to.window(driver.window_handles[1])
                            new_link = driver.current_url
    ...
    def meus_simulados(self, cookies):
        ...
        infos = estrategia_session.get('https://www.estrategiavestibulares.com.br/aluno/simulados', headers=self.account_header, cookies=cookies)
        cursos = bs(infos.content, 'html.parser').findAll('div', class_='card-body')
